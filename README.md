...
Current Android 15 contract selection: 663 stock-derived files (`P0=114`, `P1=530`, `P2 RED/Leia=19`). `SOURCE_LOCK.json` pins the `.118` archive/build identity and selected-file count; `proprietary-manifest.json` records exact per-file SHA-256 provenance.
